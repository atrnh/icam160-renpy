...
screen eyenet_icon:
    imagebutton auto "gui/buttons/eyenet_%s.png" xpos 651 ypos 340 action Jump("eyenet_input")
...
init -2:
    ...
    style notifications_frame is frame:
        background Frame("gui/screens/book_notifications_bg.png", 2, 22)
        xsize 222
        xmargin 0 ymargin 0
        xpadding 0 ypadding 0 
...
screen mailbox:
    ...
    drag id "mail_drag":
        ...
        frame:
            ...
            for item in mail:
                if item.view:
                    textbutton ("NEW" + item.sender + item.subject) action [item.mark_read, SetVariable("current_message", item), Show("message")] style "large_textbutton"
                else:
            ...
            vbox:
                ...
                if current_message is not None:
                    ...
                    frame style "text_frame":
                        ...
                        if eyenet:
                            null height 20
                            textbutton ("Download attachment: eyenet.exe") action Show("eyenet_icon") style "large_textbutton"
                else:
                    hbox:
                        null height 50
